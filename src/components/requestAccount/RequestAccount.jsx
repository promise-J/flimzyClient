...
const RequestAccount = () => {
  ...
  return (
    <div className='left setting requestAccount'>
      ...
      <p style={{ margin: '16px 20px', fontSize: 17, color: themeBg.color, lineHeight: 1.6 }}>Messages and call in end-to-end encrypted stay between you and the people you choose.
        Not even WhatsApp can read or listen to them. <span style={{ color: themeBg.color }}>Learn more</span>
      </p>
      <div className='security-details'>
        ...
        <div className='security-detail'>
          ...
          <span>Get notified when security code changes for a contact's phone. If you have multiple devices,
            this settings must be enabled on the device where you want to get notification. <span style={{ color: themeBg.color, fontSize: 14 }}>Learn more</span></span>
        </div>
      </div>
