...
const MessageBody = ({
  ...
  return (
    <div className="right-container" ref={messagesEndRef}>
      ...
      <p>
        <i className="fa fa-lock" aria-hidden="true"></i>Welcome! This is the
        begining of your chat. You can report any activity to flimzy app. We
        trust you have a nice time.
      </p>

      {/* {msgLoad ? <p>Loading...</p> :  */}
      {messages
        .filter((msg) => msg.content.toLowerCase().includes(searchMessage))
        .map((msg) => (
          <MessageText
            key={msg._id}
            msg={msg}
